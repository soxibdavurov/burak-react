...
import { BorderTop, DescriptionOutlined } from "@mui/icons-material";
...
<Container>
    <Stack className="popular-section">
      ...
      <CardContent sx={{ justifyContent: 'flex-end' }}>
        ...
        > {ele.productViews}
        <VisibilityIcon style={{marginLeft:"5px", fontSize:"25px" }} />   
        </Typography>
        ...
        sx={{
            ...
            >
                {ele.productDesc}
                            ...
                            <Box className="no-data">Popular dishes are not available yet!</Box>
                        )}
        </Stack>
